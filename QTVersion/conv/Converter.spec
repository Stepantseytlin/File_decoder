...
a = Analysis(
    ['C:\\FileDecoder\\File_decoder\\File_decoder\\QTVersion\\convert_to_canlog.py'],
    pathex=['C:\\FileDecoder\\File_decoder\\File_decoder\\QTVersion', 'C:\\FileDecoder\\File_decoder\\File_decoder\\QTVersion'],
